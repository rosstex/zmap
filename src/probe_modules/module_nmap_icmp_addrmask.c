...
probe_module_t module_nmap_icmp_addrmask;

static int nmap_icmp_addrmask_init_perthread(void *buf, macaddr_t *src, macaddr_t *gw,
...
static int nmap_icmp_addrmask_make_packet(void *buf, UNUSED size_t *buf_len,
...
static void nmap_icmp_addrmask_print_packet(FILE *fp, void *packet)
{
...
static void nmap_icmp_addrmask_process_packet(const u_char *packet,
...
probe_module_t module_nmap_icmp_addrmask = {.name = "nmap_icmp_addrmask",
				   .packet_length = 46,
				   .pcap_filter = "icmp",
				   .pcap_snaplen = 100,
				   .port_args = 0,
				   .thread_initialize =
				       &nmap_icmp_addrmask_init_perthread,
				   .make_packet = &nmap_icmp_addrmask_make_packet,
				   .print_packet = &nmap_icmp_addrmask_print_packet,
				   .process_packet = &nmap_icmp_addrmask_process_packet,
